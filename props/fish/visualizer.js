...
import { Peixe } from './fish.js';
import { configureTextura } from '../props.js';

const BODY_TEXTURE = "../textures/clown_fish.jpg";
const TAIL_TEXTURE = "../textures/clown_fish.jpg";
...
function crieInterface() {
  document.getElementById("xButton").onclick = function () {
    gPeixe.axis = EIXO_X_IND;
  };
  document.getElementById("yButton").onclick = function () {
    gPeixe.axis = EIXO_Y_IND;
  };
  document.getElementById("zButton").onclick = function () {
    gPeixe.axis = EIXO_Z_IND;
  };
  document.getElementById("pButton").onclick = function () {
    gPeixe.rodando = !gPeixe.rodando;
  };
...
function crieShaders() {
  ...
  gShader.fishBodyVao = setVAO(gPeixe.body);
  gShader.fishTailVao = setVAO(gPeixe.tail);
...
function render() {
  ...
  gCtx.view = lookAt(eye, at, up);
  gl.uniformMatrix4fv(gShader.uView, false, flatten(gCtx.view));  // renderiza o peixe
  const materials = {
    fishBody: bodyTexture,
    fishTail: tailTexture
  };
  gPeixe.render(gl, gShader, gCtx, mat4(), materials, true);
